LootJS.lootTables(e => {
    ...
    let table = e.getLootTable('nova_structures:chests/piglin_outstation/outstation_generic')
    table.clear()
    table.createPool(pool => {
        ...
        pool.addEntry(LootEntry.reference('lc:tables/general/piglin/equipment/iron').withWeight(18))
        ...
        pool.addEntry(LootEntry.of(`${mc}:shroomlight`, [1, 3]).withWeight(3))
        pool.addEntry(LootEntry.of(`${mc}:fire_charge`, [1, 5]).withWeight(3))
        pool.addEntry(LootEntry.of(`${mc}:crimson_stem`, [3, 16]).withWeight(3))
        pool.addEntry(LootEntry.of(`${nd}:rock_soup`, [2, 5]).withWeight(2))
