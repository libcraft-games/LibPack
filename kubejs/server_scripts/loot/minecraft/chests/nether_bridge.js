LootJS.lootTables(e => {
    ...
    table.createPool(pool => {
        pool.rolls([3, 7])
        pool.addEntry(LootEntry.reference('lc:tables/structure/minecraft/fortress/filler').withWeight(17))
        pool.addEntry(LootEntry.reference('lc:tables/structure/minecraft/fortress/singles').withWeight(12))
