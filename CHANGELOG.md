...
- WATUT no longer shows item transfers between players and chests, which was just kinda annoying (#264)
- reduced durability damage taken by [Guard Villager](https://modrinth.com/mod/guard-villagers) equipment (1bae399)
- washing Wither Rose now produces a BOP Rose instead of a Poppy (afa0e69)
